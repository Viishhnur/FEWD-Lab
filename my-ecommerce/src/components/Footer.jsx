const Footer = ({ darkMode }) => {
    return (
      <footer className={`${darkMode ? 'bg-dark' : 'bg-light'} ${darkMode ? 'text-light' : 'text-dark'} pt-5 pb-4`}>
        <div className="container">
          <div className="row g-4">
            <div className="col-12 col-md-4">
              <h5>ShopEase</h5>
              <p className="text-muted">Premium online shopping experience</p>
              <div className="d-flex gap-3">
                <a href="#" className={`${darkMode ? 'text-light' : 'text-dark'}`}>
            ...
            <div className="col-12 col-md-4">
              <h5>Get Updates</h5>
              <p className="text-muted">Subscribe to our newsletter for exclusive offers</p>
              <div className="input-group">
                <input type="email" className="form-control" placeholder="Email address" />
                <button className={`btn ${darkMode ? 'btn-light' : 'btn-dark'}`}>Subscribe</button>
              </div>
            </div>
          </div>
          ...
          <div className="row mt-5 pt-4 border-top">
            <div className="col-md-6 text-center text-md-start">
              <p className="text-muted mb-0">&copy; 2024 ShopEase. All rights reserved</p>
            </div>
